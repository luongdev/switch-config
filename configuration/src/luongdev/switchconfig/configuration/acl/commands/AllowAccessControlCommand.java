...
public class AllowAccessControlCommand implements Request<AccessControl> {
    ...
    public AllowAccessControlCommand(UUID id, String cidr, String domain, String description) {
        assert id != null;
    ...
    public AllowAccessControlCommand(UUID id, String cidr, String domain) {
